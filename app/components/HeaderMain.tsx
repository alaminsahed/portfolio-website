                ...
                return (
                  <div key={index} className="relative group">
                    ...
                    <div className="pointer-events-none group-hover:pointer-events-auto absolute bottom-full left-1/2 -translate-x-1/2 mb-3 opacity-0 group-hover:opacity-100 transition-opacity duration-150 z-50">
                      <div className="flex items-center gap-2 bg-gray-900/95 backdrop-blur-sm text-white text-xs rounded-lg px-3 py-2 whitespace-nowrap shadow-xl">
                        ...
                        <button
                          ...
                          className="ml-1 flex items-center justify-center w-5 h-5 rounded hover:bg-white/10 transition-colors"
